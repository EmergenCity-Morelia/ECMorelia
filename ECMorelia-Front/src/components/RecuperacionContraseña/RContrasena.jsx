...
<h1 className="font-black text-5xl text-center mt-9 text-neutral-900">¿OLVIDASTE TU</h1><span></span> <h1 className="font-black text-5xl text-center text-cyan-500">CONTRASEÑA?</h1>
